...
outputs = [
    gr.outputs.Label(label="VIT"), 
    gr.outputs.Label(label="Deit")
]
examples = [['cat.jpg'], ['dog.jpg']]
Parallel(io1, io2, inputs, outputs, title=title, description=description, article=article, examples=examples).launch()